...
export interface IQueryEngineClient {
     ...
     */
    fetchBatch(input: FetchBatchRequest, options?: RpcOptions): ServerStreamingCall<FetchBatchRequest, FetchBatchResponse>;
    /**
     ...
     */
    cancelQuery(input: CancelQueryRequest, options?: RpcOptions): UnaryCall<CancelQueryRequest, CancelQueryResponse>;
    /**
     * Get query status
     *
     * @generated from protobuf rpc: GetQueryStatus(query_engine.QueryStatusRequest) returns (query_engine.QueryStatusResponse);
     */
    getQueryStatus(input: QueryStatusRequest, options?: RpcOptions): UnaryCall<QueryStatusRequest, QueryStatusResponse>;
}
/**
 * @generated from protobuf service query_engine.QueryEngine
 */
export class QueryEngineClient implements IQueryEngineClient, ServiceInfo {
    ...
    fetchBatch(input: FetchBatchRequest, options?: RpcOptions): ServerStreamingCall<FetchBatchRequest, FetchBatchResponse> {
        ...
        return stackIntercept<FetchBatchRequest, FetchBatchResponse>("serverStreaming", this._transport, method, opt, input);
    }
    /**
     * Cancel an in-progress query
     *
    ...
    cancelQuery(input: CancelQueryRequest, options?: RpcOptions): UnaryCall<CancelQueryRequest, CancelQueryResponse> {
        ...
        return stackIntercept<CancelQueryRequest, CancelQueryResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Get query status
     *
    ...
    getQueryStatus(input: QueryStatusRequest, options?: RpcOptions): UnaryCall<QueryStatusRequest, QueryStatusResponse> {
        ...
        return stackIntercept<QueryStatusRequest, QueryStatusResponse>("unary", this._transport, method, opt, input);
    }
}
