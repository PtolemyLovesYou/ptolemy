...
class QueryStatusResponse$Type extends MessageType<QueryStatusResponse> {
  constructor() {
    super('query_engine.QueryStatusResponse', [
      { no: 1, name: 'query_id', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        name: 'status',
        kind: 'enum',
        T: () => ['query_engine.QueryStatus', QueryStatus],
      },
      {
        no: 3,
        name: 'error',
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional query_engine.QueryMetadata metadata */ 4:
          message.metadata = QueryMetadata.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.metadata,
        ...
        case /* google.protobuf.Timestamp last_updated */ 5:
          message.lastUpdated = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lastUpdated,
  ...
  internalBinaryWrite(
    ...
    if (message.metadata)
      QueryMetadata.internalBinaryWrite(
        message.metadata,
...
export const QueryEngine = new ServiceType('query_engine.QueryEngine', [
  ...
  },
  {
    name: 'GetQueryStatus',
    options: {},
    I: QueryStatusRequest,
    O: QueryStatusResponse,
  },
]);
