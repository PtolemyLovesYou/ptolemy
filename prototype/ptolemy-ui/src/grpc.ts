...
export const fetchData = async (client: QueryEngineClient, queryId: string): Promise<[string[], string[][]]> => {
...
export async function runQueryAndGetData(query: string): Promise<[string[], string[][]]> {
