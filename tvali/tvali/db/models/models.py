...
from .core import Event, EventRuntime, EventInput, EventOutput, EventFeedback, EventMetadata
...
class SystemEvent(Event):
    ...
    event_feedback: Mapped[List["SystemFeedback"]] = relationship(back_populates="event")
    event_metadata: Mapped[List["SystemMetadata"]] = relationship(back_populates="event")

    subsystem_events: Mapped[List["SubsystemEvent"]] = relationship(back_populates="system_event")
...
class SubsystemEvent(Event):
    ...
    event_outputs: Mapped[List["SubsystemOutput"]] = relationship(back_populates="event")
    event_feedback: Mapped[List["SubsystemFeedback"]] = relationship(back_populates="event")
    event_metadata: Mapped[List["SubsystemMetadata"]] = relationship(back_populates="event")
...
class SubsystemRuntime(EventRuntime):
    ...
    subsystem_event_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("subsystem_event.id"))
...
class ComponentEvent(Event):
    ...
    event_outputs: Mapped[List["ComponentOutput"]] = relationship(back_populates="event")
    event_feedback: Mapped[List["ComponentFeedback"]] = relationship(back_populates="event")
    event_metadata: Mapped[List["ComponentMetadata"]] = relationship(back_populates="event")

    subsystem_event_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("subsystem_event.id"))
    subsystem_event: Mapped[SubsystemEvent] = relationship(back_populates="component_events")
...
class ComponentRuntime(EventRuntime):
    ...
    component_event_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("component_event.id"))
...
class SubcomponentEvent(Event):
    ...
    event_inputs: Mapped[List["SubcomponentInput"]] = relationship(back_populates="event")
    event_outputs: Mapped[List["SubcomponentOutput"]] = relationship(back_populates="event")
    event_feedback: Mapped[List["SubcomponentFeedback"]] = relationship(back_populates="event")
    event_metadata: Mapped[List["SubcomponentMetadata"]] = relationship(back_populates="event")

    component_event_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("component_event.id"))
    component_event: Mapped[ComponentEvent] = relationship(back_populates="subcomponent_events")
...
class SubcomponentRuntime(EventRuntime):
    ...
    subcomponent_event_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("subcomponent_event.id"))
