...
use apollo_compiler::{ApolloCompiler, HirDatabase, hir::OperationType};
...
fn gql_compiler() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("cargo:warning=# Operations: {}", compiler.db.all_operations().len());
    ...
    let out_dir = PathBuf::from("src/generated/gql_ops.rs");

    let mut query_string = "// This file is @generated by ptolemy <3.\n\n".to_string();
    for query in queries {
        query_string.push_str(&format!("pub const {}_QUERY: &'static str = r###\"{}\"###;\n\n", query.to_shouty_snake_case(), query));
    }

    for mutation in mutations {
        query_string.push_str(&format!("pub const {}_MUTATION: &'static str = r###\"{}\"###;\n\n", mutation.to_shouty_snake_case(), mutation));
    }

    query_string.push_str(&format!("pub const QUERY: &'static str = r###\"{}\"###;\n\n", query));
    query_string.push_str(&format!("pub const MUTATION: &'static str = r###\"{}\"###;\n\n", mutation));
