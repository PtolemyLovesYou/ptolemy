use crate::api::models::{User, Workspace, WorkspaceRoleEnum};
...
impl Into<crate::models::auth::WorkspaceUser> for WorkspaceUser {
    fn into(self) -> crate::models::auth::WorkspaceUser {
        crate::models::auth::WorkspaceUser {
