use crate::api::models::{ApiKeyPermissionEnum, Workspace};
...
impl Into<crate::models::auth::ServiceApiKey> for ServiceApiKey {
    fn into(self) -> crate::models::auth::ServiceApiKey {
        crate::models::auth::ServiceApiKey {
            id: self.id.into(),
