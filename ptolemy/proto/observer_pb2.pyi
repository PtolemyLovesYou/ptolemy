...
class PublishResponse(_message.Message):
    ...
    message: str
    def __init__(self, successful: bool = ..., jobs: _Optional[_Iterable[_Union[RecordPublishJob, _Mapping]]] = ..., message: _Optional[str] = ...) -> None: ...
...
class RecordPublishJob(_message.Message):
    ...
    id: str
    stream_key: str
    def __init__(self, id: _Optional[str] = ..., stream_key: _Optional[str] = ...) -> None: ...
