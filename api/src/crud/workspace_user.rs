...
pub async fn create_workspace_user(conn: &mut DbConnection<'_>, wk_user: &WorkspaceUser) -> Result<(), CRUDError> {
...
pub async fn set_workspace_user_role(conn: &mut DbConnection<'_>, wk_id: Uuid, us_id: Uuid, role: WorkspaceRoleEnum) -> Result<(), CRUDError> {
